...
public sealed class ServiceCollectionExtensionsTests
{
    ...
    public async Task AddDevHubSdk_WithNamedHttpClientCustomization_ShouldCreateClientsThroughHttpClientPipeline()
    {
        ...
        var httpClientProvider = provider.GetRequiredService<IDevHubHttpClientProvider>();
        var transportFactory = provider.GetRequiredService<IDevHubHttpTransportFactory>();
        var sessionFactory = provider.GetRequiredService<IDevHubWebSocketSessionFactory>();
        ...
        Assert.IsType<JsonRpcHttpTransportFactory>(transportFactory);
        Assert.IsType<JsonRpcWebSocketSessionFactory>(sessionFactory);
