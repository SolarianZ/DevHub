...
python3 src/tests/test_runner.py --full --no-header
```
...
- `python3 src/tests/test_runner.py --smoke --no-header` 与 `python3 src/tests/test_runner.py --full --no-header` 默认针对“已启动的本地 Hub”执行；若需要隔离 Hub 夹具或自定义启动方式，请参考 [`src/tests/README.md`](../src/tests/README.md)。
- 更细的黑盒测试夹具说明见 [`src/tests/README.md`](../src/tests/README.md)。
